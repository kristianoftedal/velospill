...
Plans:
- [x] 13-01-PLAN.md — Update order type seed data and create migration script for 2026 multipliers (completed 2026-02-22, 156s, 2 commits)
- [x] 13-02-PLAN.md — Update order effect application logic for new effect types and Kaptein on women's WC (completed 2026-02-22, 169s, 2 commits)
...
Plans:
- [x] 14-01-PLAN.md — Remove blowback from counter mechanic, return countered orders to attacker for reuse (completed 2026-02-22, 154s, 3 commits)
...
- [x] 15-02-PLAN.md — Implement Uno-X order backend logic and scoring integration (completed 2026-02-22, 168s, 2 commits)
- [x] 15-03-PLAN.md — Build admin and team UI for bonus rider draft management and picking (completed 2026-02-22, 233s, 2 commits)
